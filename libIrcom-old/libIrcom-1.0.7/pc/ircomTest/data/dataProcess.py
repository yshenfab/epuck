...
for i in range(len(sensorId)):
    if sensorId[i] == str(0):
        s0.append(distance[i])
    elif sensorId[i] == str(1):
        s1.append(distance[i])
    elif sensorId[i] == str(2):
        s2.append(distance[i])
    elif sensorId[i] == str(3):
        s3.append(distance[i])
    elif sensorId[i] == str(4):
        s4.append(distance[i])
    elif sensorId[i] == str(5):
        s5.append(distance[i])
    elif sensorId[i] == str(6):
        s6.append(distance[i])
    elif sensorId[i] == str(7):
        s7.append(distance[i])
...
print("Sensor 0-7 min:")
print(sensor_min)
print("Sensor 0-7 max:")
print(sensor_max)
print("Sensor 0-7 avg:")
print(sensor_avg)
