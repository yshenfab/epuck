...
#include "../MultiPlatformMonitorSrc1.8/EpuckMonitor.h"
...
QT_MOC_LITERAL(35, 338, 10) // "portOpened"
    ...
    "getImages\0printMessage\0s\0portOpened"
};
...
void EpuckMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EpuckMonitor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (EpuckMonitor::*)(int , int , int , int );
        ...
        {
            using _t = void (EpuckMonitor::*)(int );
        ...
        {
            using _t = void (EpuckMonitor::*)(char * );
...
QT_INIT_METAOBJECT const QMetaObject EpuckMonitor::staticMetaObject = { {
    ...
    qt_meta_stringdata_EpuckMonitor.data,
    qt_meta_data_EpuckMonitor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
